...
public class BoardDao {
	...
	public List<Board> selectAll(Pager pager) {
		...
		try {
			...
			String sql = new StringBuilder()
					.append("select rnum, bno, btitle, bwriter, bdate")
					.append(" from (")
					.append(" 	select rownum as rnum, bno, btitle, bwriter, bdate")
					.append(" 	from (")
	...
	public Board selectByBno(int bno,Board board) {
		...
		try {
			...
			// 실행해야 할 SQL 작성
			String sql = "SELECT bno, btitle, bcontent, bwriter, bdate, bfilename, bfiledata,bpassword FROM boards WHERE bno=?";
	...
	public int insert(Board board) {
		...
		try {
			...
			sql += (board.getBfilepath() != null) ? ", bfilename=?, bfiledata=?" : ",null,null";
			sql += (board.getBpassword() != null) ? ", bpassword=?,null )" : ",null,null)";
